...
import data from "../data/sagaData.json";
import '../App.css';
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          {/*佐賀のご紹介*/}
            <div className="grid sm:grid-cols-2 gap-20 mx-5 mt-20">
              <div className="mt-1">
                <h4 className="text-2xl font-bold text-gray-600">{t('saga_introduction.watch_video')}</h4>
                <video controls="controls" className="mt-5">
                  <source
                  ...
                  <div className="galary-content">
                    <figure className="flex justify-center">
                      ...
                      <figcaption className="flex justify-end mt-20">
                        <a href={data.address}
                           className="w-[40px] h-[40px] flex items-center justify-center shadow-lg rounded-sm border-1 border-warning-300"
                           target="_blank">
